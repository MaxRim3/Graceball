...
#region Unity Messages
	...
	protected virtual void UpdateAnchors(bool updateEyeAnchors, bool updateHandAnchors)
	{
		...
		if (updateHandAnchors)
		{
			...
			{
                Vector3 finalLeftPos = OVRInput.GetLocalControllerPosition(OVRInput.Controller.LTouch) + (OVRInput.GetLocalControllerPosition(OVRInput.Controller.LTouch) - centerEyeAnchor.localPosition);
				leftHandAnchor.localPosition = (finalLeftPos);

                Vector3 finalRightPos = OVRInput.GetLocalControllerPosition(OVRInput.Controller.RTouch) + (OVRInput.GetLocalControllerPosition(OVRInput.Controller.RTouch) - centerEyeAnchor.localPosition);
